...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile, mOrientation, isFrontCamera));
        }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            mCameraId = isFrontCamera ? getFrontCameraId(manager) : getBackCameraId(manager);
    ...
    private void captureStillPicture() {
        ...
        try {
            ...
            // Orientation
            int rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
            captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, getOrientation(characteristics, rotation));
    ...
    private int getOrientation(CameraCharacteristics c, int deviceOrientation) {
        ...
        Log.d(TAG, "sensorRotation: " + sensorOrientation);

        // Round device orientation to a multiple of 90 degrees
        ...
        // Calculate desired JPEG orientation relative to camera orientation to make the image upright
    ...
    private static class ImageSaver implements Runnable {
        ...
        ImageSaver(Image image, File file, int orientation, boolean isFrontCamera) {
            mImage = image;
            mFile = file;
        ...
        public void run() {
            ...
            try {
                ...
                Matrix matrix = new Matrix();
                if (isFrontCamera) matrix.postRotate(mOrientation - 90);
                else matrix.postRotate(mOrientation + 90);
...
//                output.write(bytes);
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton(android.R.string.ok, (dialog, which) -> parent.requestPermissions(new String[]{android.Manifest.permission.CAMERA},
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        Log.d(TAG, "config: " + newConfig.orientation);
    }
}